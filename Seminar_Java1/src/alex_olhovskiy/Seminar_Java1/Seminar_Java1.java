...
public class Seminar_Java1 {
	...
	public static void CalculatorSuorce()
	{
		...
		{
			CalculatorMenu();
			System.out.println("ƒелайте выбор");
			c=input.next();
			switch(c)
			{
				case "+":
					System.out.println("¬ведите 1-ое число");
					first=input.nextInt();
					System.out.println("¬ведите 2-ое число");
	...
	public static void CalculatorMenu()
	{
		...
		System.out.println("*     ¬ведите '*'");
		System.out.println("/     ¬ведите '/'");
		System.out.println("pow   ¬ведите 'pow'");
		System.out.println("sqrt  ¬ведите 'sqrt'");
		System.out.println("¬ыход ¬ведите 'q'");
